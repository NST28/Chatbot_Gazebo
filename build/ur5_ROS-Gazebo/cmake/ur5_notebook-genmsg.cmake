...
message(STATUS "ur5_notebook: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iur5_notebook:/home/trung/sim/vacuum/src/ur5_ROS-Gazebo/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/trung/sim/vacuum/src/ur5_ROS-Gazebo/msg/blocks_poses.msg" NAME_WE)
add_custom_target(_ur5_notebook_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur5_notebook" "/home/trung/sim/vacuum/src/ur5_ROS-Gazebo/msg/blocks_poses.msg" ""
)
...
_generate_msg_cpp(ur5_notebook
  "/home/trung/sim/vacuum/src/ur5_ROS-Gazebo/msg/blocks_poses.msg"
  "${MSG_I_FLAGS}"
  ""
